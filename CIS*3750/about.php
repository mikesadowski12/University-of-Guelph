    ...
    <div class="container" style="color:white">
        <div class="row">
          ...
          <div class="col-xs-12" style="padding: 10px;">
          	<h1>About Us</h1>
            <hr>
          	<img src="/cfc/Images/alpaca.jpg" class="col-sm-4" width="100%">
          	<div class="col-sm-8">
              <p class="cfc-font" style="text-indent: 4em;">
              ...
              <p class="cfc-font" style="text-indent: 4em;">
            Nullam ultrices mattis velit ut volutpat. Duis et lorem quam. Aenean metus justo, iaculis non magna eget, commodo tempus felis. Mauris sed est lectus. Vivamus pharetra lacus quis nunc porta, vitae porta velit malesuada. Cras finibus purus quam, et commodo libero commodo vel. Sed varius tortor tempor sem blandit finibus. Suspendisse ligula odio, ultricies et orci in, feugiat luctus magna. Integer non lorem vulputate, sollicitudin urna ut, consequat ligula. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam a rutrum eros. Duis nec erat sagittis elit consequat tempus. Ut laoreet laoreet ipsum, quis convallis lorem varius posuere. Ut iaculis urna porttitor sapien venenatis, eget tempor tellus consectetur. Proin quis velit maximus, mattis magna et, lobortis sapien. Fusce accumsan mollis tortor, eu lobortis erat egestas quis.
              </p>
            </div>
          </div>
        </div>
