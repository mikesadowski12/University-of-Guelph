          ...
          <form>
            <div class="col-sm-12">
              <div class="row">
                ...
                <img src="http://cliparts.co/cliparts/kc8/oLK/kc8oLKa6i.gif" alt="testPic" height = "350" width = "400" style="padding-left:50px;" ><br/><br/>
              </div>

              <button type="button" class="btn btn-lg btn-info" onclick="declinePage()">Decline</button>
              <a href="/cfc/Includes/php/eventRegister-request.php"><button type="button" class="btn btn-lg btn-info">Accept</button></a>
            </div>
          </form>
        </div>
      </div>
